...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        <div id="bulkOptionsContainer" class="col-xs-2">
            <select name="bulk_options" class="form-control" id="test">
...
//            }
            ...
            echo "<td><a href='post_comments_id.php?id=$post_id'>$count_comments</a></td>";
            echo "<td>$post_date</td>";
            echo "<td><a class='btn btn-info' href='../post.php?p_id={$post_id}'>View Post</a></td>";
            echo "<td><a class='btn btn-default' href='posts.php?source=edit_post&p_id={$post_id}'>Edit</a></td>";
...
//            echo "<td><a rel='$post_id' href='javascript:void(0)' class='delete_link'>Delete</a></td>";
        ...
        // it was not here, I added in the lesson of 3 min, 136#
        // I think this piece of code exists somewhere else
